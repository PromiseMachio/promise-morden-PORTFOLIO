    ...
    hero: [
      {
        ...
        colors: [
          { color: 'rgba(141,255,105,0.25)', stop: '100%' },//stop:10%
          { color: 'rgba(141,255,105,0.45)', stop: '100%' },//stop:30%
          { color: 'rgba(141,255,105,0.5)', stop: '100%' },//stop:50
          { color: 'rgba(141,255,105,0.45)', stop: '100%' },//stop:70
          { color: 'rgba(141,255,105,0.25)', stop: '100%' }//stop:90
        ],
        blur: '0px',
        opacity: 0.5
      },
