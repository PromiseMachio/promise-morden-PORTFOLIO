...
export const Projects = () => {
    ...
    return <section id='projects' className='relative py-20 bg-black overflow-hidden'>
        <div className='absolute inset-0 overflow-hidden'>
            ...
            <div className='absolute top-1/3 right-1/2  w-96 h-96 bg-primary/20 opacity-20 rounded-3xl blur-3xl' />
        </div>
                    ...
                    {cartegories.map((category) => (
                        ...
                        >
                            ...
                            <div className='relative flex items-center gap-2'>
                                {React.createElement(categoryIcon[category], { className: 'w-4 h-4' })}
                    ...
                    {filteredProjects.length > 3 && (
                        <>
                            <button
                                ...
                                className='flex absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 lg:-translate-x-4 items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border-white/20 rounded-full hover:bg-white/40 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed z-10'
                            ...
                            <button
                                ...
                                className='flex absolute right-0 top-1/2 -translate-y-1/2 -translate-x-2 lg:-translate-x-4 items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border-white/20 rounded-full hover:bg-white/40 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed z-10'
                            ...
                            {Array.from({ length: Math.max(0, filteredProjects.length - 2) }).map((_, index) => (
                                <button
                                    ...
                                    className={`transition-all duration-300  rounded-full ${index === currentIndex
                                        ? 'bg-primary w-6 h-2'
                                        : 'bg-white w-2 h-2 hover:bg-white/60'
                                        }`}
